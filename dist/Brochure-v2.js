...
var Brochure = /*#__PURE__*/function (_React$Component) {
  _inherits(Brochure, _React$Component);

  var _super = _createSuper(Brochure);
  ...
  _createClass(Brochure, [{
    ...
    value: function next(tourId) {
      ...
      if (!tourId) {
        ...
        console.log("tour: ".concat(tourId, " - ").concat(this.state.list.find(function (x) {
          return x.id === tourId;
        }).currentStep, " - next"));
      }
    ...
    value: function render() {
      return /*#__PURE__*/_react["default"].createElement("div", null, "render() ", this.state.testVal);
    }
  }]);
